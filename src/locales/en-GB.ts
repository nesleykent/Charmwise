...
const en: Dictionary = {
  ...
  recommendationsPage: {
    ...
    modeLabel: 'Recommendation view',
    modeDescriptions: {
      damage_first: 'Default. Damage first because it usually improves XP, profit, safety, supply efficiency and spawn control together.',
      damage: 'Sort only by expected effective charm damage.',
      budget_damage: 'Prefer damage that costs fewer Charm Points or Minor Charm Echoes.',
      defensive: 'Use only when incoming damage creates a concrete survival reason.',
      sustain: 'Compare Life Leech, Mana Leech and Mana Drain relief.',
      control: 'Compare paralysis, fleeing prevention and other control value.',
      manual: 'Only compare the Charms you select below.',
    },
    modes: {
      damage_first: 'Recommended',
      damage: 'Best damage',
      budget_damage: 'Best budget damage',
      defensive: 'Best defensive',
  ...
  results: {
    ...
    chooseCharmsDefaultNote:
      'No manual selection yet - showing a damage-first shortlist. Select Charms to narrow the comparison to only what you want to inspect.',
    chooseCharmsManualEmptyNote: 'Manual comparison is selected. Choose one or more Charms below to populate the table.',
    chooseCharmsManualNote: 'Only selected Charms are compared below. Remove a chip or clear the selection to return to the default shortlist.',
    clearSelection: 'Clear selection',
    noUnlockedCharmNotice: 'No charms are currently unlocked. These results show the best first unlocks for this hunt.',
    noMeaningfulComparison: 'No selected Charm has a meaningful non-zero value for this hunt.',
    nonDamageReasonDisclosure:
      'Non-damage choices only win here because this view has concrete survival, sustain, control, or utility data supporting them.',
    advancedFullRanking: 'Advanced full ranking',
    formulaDebugDetails: 'Formula/debug details',
    noActionableUpgrades: 'No actionable positive upgrade found for the current data and target tier.',
    sameRank: 'same rank',
    effectivelyTied: 'effectively tied',
    comparisonCharm: 'Charm',
    comparisonCreature: 'Creature',
    comparisonRole: 'Role',
    comparisonTier: 'Tier',
    comparisonMainGain: 'Main expected gain',
    comparisonCost: 'Cost',
    comparisonEfficiency: 'Efficiency',
    comparisonConfidence: 'Confidence',
    comparisonReason: 'Reason',
    roles: {
      damage: 'Damage',
      budget_damage: 'Budget damage',
      defensive: 'Defensive',
      sustain: 'Sustain',
      control: 'Control',
      loot_utility: 'Loot utility',
      utility: 'Utility',
    },
    roleExplanations: {
      damage: '{{charm}} is always Damage - it deals or amplifies damage by what it structurally does, not by this hunt\'s numbers.',
      budget_damage: '{{charm}} is always Damage - it deals or amplifies damage by what it structurally does, not by this hunt\'s numbers.',
      defensive: '{{charm}} is always Defensive - it reduces or reflects incoming damage by what it structurally does, not by this hunt\'s numbers.',
      sustain: '{{charm}} is always Sustain - it restores or saves HP/mana by what it structurally does, not by this hunt\'s numbers.',
      control: '{{charm}} is always Control - it disables the creature or denies it an escape by what it structurally does, not by this hunt\'s numbers.',
      loot_utility: '{{charm}} is always Loot utility - it increases gold or items earned, not combat performance.',
      utility: '{{charm}} is always Utility - situational value that is not damage, defence, sustain, control, or loot.',
    },
    decisionReasons: {
      damage_gain: 'Best effective damage gain for {{creature}}, which also tends to improve XP, profit, safety and supply efficiency.',
      creature_share: '{{creature}} is {{share}}% of the hunt, so damage on this creature has high session impact.',
      unlock_candidate: '{{charm}} is locked, but it is one of the strongest first unlock candidates for {{creature}} in this hunt.',
      defensive_need: 'High incoming damage gives this defensive value a concrete reason to compete with damage.',
      sustain_need: 'Sustain is supported by actual damage, leech, or mana-drain data for this hunt.',
      control_need: 'Control value is backed by paralysis or flee-prevention mechanics instead of raw score filler.',
      loot_utility: 'Loot utility is shown because this creature has usable product, skinning, dusting, or profit data.',
    },
    ...
    calculationDetailsTitle: 'Calculation details',
    ...
    modelNoSpecificFormula: 'This Charm uses a qualitative or data-backed EV model; the outputs below are the model result for this creature.',
    metrics: {
      expectedDamagePerHour: 'Expected charm damage / hour',
      expectedXpPerHour: 'Expected XP gain / hour',
      ...
      roleMetricPerCharmPoint: 'Gain per Charm Point',
      roleMetricPerMinorCharmEcho: 'Gain per Minor Charm Echo',
    },
    ...
    tiedRankHint:
      'Tied with the next Charm at this value (rounded to one decimal place) - check the gain-per-cost metric or confidence to break the tie yourself.',
    rankingCriterionNote: "Ranked by each Charm's own real metric for its role (e.g. damage/hour for a Damage Charm), not by gain per cost - that's shown alongside as a separate metric, not the sort key.",
  },
  missingData: {
  ...
  messages: {
    reason_top_unlocked: 'Highest {{role}} value of every Charm for this creature - and you already have it unlocked.',
    reason_top_locked: 'Best Charm for this creature at {{tier}} tier by {{role}} value, but you have not unlocked it yet.',
    reason_ranked_unlocked: "Ranked #{{rank}} by {{role}} value. You have this one unlocked, though it isn't the single best option here.",
    reason_ranked_locked: 'Ranked #{{rank}} at {{tier}} tier by {{role}} value. Not unlocked yet.',
